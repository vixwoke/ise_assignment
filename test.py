...
rage_idle_frames = load_sheet(
    rageMainCharacterPath + "Idle.png",
    FRAME_W,
    FRAME_H
)

rage_walk_frames = load_sheet(
    rageMainCharacterPath + "Walk.png",
    FRAME_W,
    FRAME_H
)

rage_jump_frames = load_sheet(
    rageMainCharacterPath + "Jump.png",
    FRAME_W,
    FRAME_H
)

rage_attack_frames = load_sheet(
    rageMainCharacterPath + "Attack_1.png",
    FRAME_W,
    FRAME_H
)
rage_attack2_frames = load_sheet(
    rageMainCharacterPath + "Attack_2.png",
    FRAME_W,
    FRAME_H
)
rage_attack3_frames = load_sheet(
    rageMainCharacterPath + "Attack_3.png",
    FRAME_W,
    FRAME_H
)

rage_hurt_frames = load_sheet(
    rageMainCharacterPath + "Hurt.png",
    FRAME_W,
    FRAME_H
)

rage_dead_frames = load_sheet(
    rageMainCharacterPath + "Dead.png",
    FRAME_W,
    FRAME_H
)

rage_shot_frames = load_sheet(
    rageMainCharacterPath + "Leap_Attack.png",
    FRAME_W,
    FRAME_H
)
rage_attack_list = [
...
enemyAttack_frames = load_sheet(
    enemyPath + "Attack_1.png",
    FRAME_W,
    FRAME_H
)

enemyHurt_frames = load_sheet(
    enemyPath + "Hurt.png",
    FRAME_W,
    FRAME_H
)

enemyIdle_frames = load_sheet(
    enemyPath + "Idle.png",
    FRAME_W,
    FRAME_H
)

enemyDead_frames = load_sheet(
    woundedEnemyPath + "Dead.png",
    FRAME_W,
    FRAME_H
)
enemyWalk_frames = load_sheet(
    enemyPath + "Walk.png",
    FRAME_W,
    FRAME_H
)
enemyRun_frames = load_sheet(
    enemyPath + "Run.png",
    FRAME_W,
    FRAME_H
)
...
woundedAttack_frames = load_sheet(
    woundedEnemyPath + "Attack_1.png",
    FRAME_W,
    FRAME_H
)

woundedHurt_frames = load_sheet(
    woundedEnemyPath + "Hurt.png",
    FRAME_W,
    FRAME_H
)

woundedIdle_frames = load_sheet(
    woundedEnemyPath + "Idle.png",
    FRAME_W,
    FRAME_H
)


woundedWalk_frames = load_sheet(
    woundedEnemyPath + "Walk.png",
    FRAME_W,
    FRAME_H
)

woundedRun_frames = load_sheet(
    woundedEnemyPath + "Run.png",
    FRAME_W,
    FRAME_H
)
...
enemy_target_time = 5000  # 15 seconds
...
partner_idle_frames = load_sheet(
    partnerPath + "Idle.png",
    FRAME_W,
    FRAME_H
)

partner_hurt_frames = load_sheet(
    partnerPath + "Hurt.png",
    FRAME_W,
    FRAME_H
)

partner_shot_frames = load_sheet(
    partnerPath + "Shot.png",
    FRAME_W,
    FRAME_H
)

partner_dead_frames = load_sheet(
    partnerPath + "Dead.png",
    FRAME_W,
    FRAME_H
)
...
civic_img = pygame.image.load(
    "partner/civic.png"
).convert_alpha()

civic_img = pygame.transform.scale(
    civic_img,
    (90, 90)
)
...
while running:
    ...
    if current_action == "attack":
        ...
        if attack_rect.colliderect(enemy_rect):
            ...
            if not enemy_dead and enemy_action != "hurt":
                ...
                # RAGE MODE ENABLE EXECUTION
                if rage_mode:
                    can_kill = True


                # EXECUTE ENEMY
                if ending_triggered and can_kill and not enemy_escape:
    ...
    if current_action == "shoot" and rage_mode:
        ...
        if leap_rect.colliderect(enemy_rect):
            ...
            if not enemy_dead and enemy_action != "hurt":
                ...
                # EXECUTE ENEMY
                if ending_triggered and can_kill:
    ...
    if not enemy_facing_right:
        enemy_frame = pygame.transform.flip(
            enemy_frame,
            True,
            False
        )
